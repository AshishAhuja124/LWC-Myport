...
import SUPERBADGE_FIELD from '@salesforce/schema/Portfolio__c.Super__c'
...
export default class PortfolioOtherDetails extends LightningElement {
    ...
    formatData(data){
        const {Awards__c, Languages__c, Super__c} = data.fields
        ...
        this.superbadges = Super__c && Super__c.value ? Super__c.value.split(';'):[]
    }
}